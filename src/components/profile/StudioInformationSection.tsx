...
import { User, MapPin, Building2, Store, CreditCard, ChevronDown, ChevronRight, Pencil, X, Save } from 'lucide-react';
...
interface StudioInformationSectionProps {
  studioInfo: StudioInfoType;
  expandedInfoSections: Record<string, boolean>;
  toggleInfoSection: (section: string) => void;
  toggleEditSection: (section: keyof StudioInfoType) => void;
  handleInfoChange: (section: keyof StudioInfoType, field: string, value: string) => void;
  saveInfoChanges: (section: keyof StudioInfoType) => void;
  cancelInfoEdit: (section: keyof StudioInfoType) => void;
}

const StudioInformationSection: React.FC<StudioInformationSectionProps> = ({
  studioInfo,
...
export default StudioInformationSection;
